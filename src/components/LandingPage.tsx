    ...
    >
      ...
      <main>
        ...
        >
          ...
          >
            <button
              id="login-btn-hero"
              onClick={onLogin}
              className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 rounded-2xl font-black text-base transition-all hover:scale-[1.03] active:scale-[0.97]"
        ...
        >
          ...
          {/* Step pills (desktop tabs / mobile scroll) */}
                  ...
                  <div className="flex items-center gap-3 pt-2">
                      ...
                      {STEPS.map((_, i) => (
                        <button
                          ...
                          style={{
                            ...
                            height: 8,
                            background: activeStep === i ? step.color : 'var(--border)',
                          }}
                        />
                      ))}
                    </div>
                    <div className="ml-auto flex gap-2">
                      <button
                        ...
                        className="w-9 h-9 rounded-xl glass flex items-center justify-center transition-all hover:bg-white/10"
                        style={{ color: 'var(--text-secondary)' }}
          ...
          <div className="max-w-5xl mx-auto px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 relative">
              ...
              <div className="absolute top-10 left-[12.5%] right-[12.5%] h-px hidden md:block"
                style={{ background: 'linear-gradient(90deg, #3b82f6, #f97316, #10b981, #a78bfa)' }} />
              ...
              {[
                ...
                <div key={num} className="flex flex-col items-center text-center gap-3 relative">
                  <div
                    className="w-20 h-20 rounded-2xl flex items-center justify-center text-2xl font-black text-white z-10"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                icon: <Brain className="w-6 h-6" />, color: '#3b82f6',
                title: 'Gemini AI Verification',
                desc: 'Every photo is auto-verified by Google Gemini Vision. No false reports, no manual moderation needed.',
              },
              {
                icon: <MapPin className="w-6 h-6" />, color: '#06b6d4',
                title: 'GPS-Tagged Reports',
                desc: 'Location is auto-detected and attached to every report so municipalities know exactly where to go.',
              },
              {
                icon: <AlertTriangle className="w-6 h-6" />, color: '#f97316',
                title: 'Severity Classification',
                desc: 'AI estimates pothole depth and classifies severity as Low, Medium, or High for prioritization.',
              },
              {
                icon: <History className="w-6 h-6" />, color: '#a78bfa',
                title: 'Live Progress Tracking',
                desc: 'Watch your report move from Reported → In Progress → Resolved with real-time status updates.',
              },
              {
                icon: <CheckCircle2 className="w-6 h-6" />, color: '#10b981',
                title: 'Before & After Proof',
                desc: 'Municipality uploads a repair photo once fixed. You can see both the original damage and the repair.',
              },
              {
                icon: <Star className="w-6 h-6" />, color: '#eab308',
                title: 'Civic Points & Badges',
                desc: 'Earn points for every verified report. Build your reputation as an Elite Road Guardian in your city.',
              },
            ].map(({ icon, color, title, desc }) => (
              <div
                key={title}
                className="glass rounded-2xl p-6 flex flex-col gap-4 transition-all hover:scale-[1.02]"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm leading-relaxed mb-8 max-w-md mx-auto" style={{ color: 'var(--text-secondary)' }}>
                Join thousands of citizens already using RoadGuard to report potholes, track repairs,
              ...
              >
                ...
                <button
                  id="login-btn-cta"
                  onClick={onLogin}
                  className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl font-black text-sm transition-all hover:scale-[1.02] active:scale-[0.98]"
      ...
      {/* SEO: Visually hidden but crawlable content */}
      <div style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap' }}>
        ...
        <p>
          ...
          Use our pothole reporting app for smart city infrastructure monitoring and road safety platform needs.
